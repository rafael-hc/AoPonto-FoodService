...
export function makeSynchronizeWizardQuestionUseCase(
  repository: WizardQuestionsRepository
) {
  return new SynchronizeWizardQuestionUseCase(repository)
}

export function makeListWizardQuestionsUseCase(
  repository: WizardQuestionsRepository
) {
  return new ListWizardQuestionsUseCase(repository)
}

export function makeGetWizardQuestionUseCase(
  repository: WizardQuestionsRepository
) {
  return new GetWizardQuestionUseCase(repository)
}

export function makeDeleteWizardQuestionUseCase(
  repository: WizardQuestionsRepository
) {
