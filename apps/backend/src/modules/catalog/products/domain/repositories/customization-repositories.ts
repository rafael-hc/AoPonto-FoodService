import { ProductDetail } from '@/catalog/products/domain/entities/product-detail'
import { ProductPersonalized } from '@/catalog/products/domain/entities/product-personalized'
