...
import type { ProductDetail } from '@/catalog/products/domain/entities/product-detail'
import type { ProductPersonalized } from '@/catalog/products/domain/entities/product-personalized'
import type { ProductSize } from '@/catalog/products/domain/entities/product-size'
import type {
  ProductDetailsRepository,
  ProductPersonalizedRepository,
  ProductSizesRepository
} from '@/catalog/products/domain/repositories/customization-repositories'
