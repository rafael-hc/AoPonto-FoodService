...
import { EditLabelDto } from '@/catalog/classifications/presentation/dtos/edit-label.dto'
import {
  FetchLabelsResponseDto,
  SingleLabelResponseDto
} from '@/catalog/classifications/presentation/dtos/label-response.dto'
import { RegisterLabelDto } from '@/catalog/classifications/presentation/dtos/register-label.dto'
import { LabelPresenter } from '@/catalog/classifications/presentation/presenters/label.presenter'
