import type { Prisma, ProductWizard as PrismaProductWizard, WizardQuestion as PrismaWizardQuestion } from '@prisma/client'
...
export const PrismaProductWizardMapper = {
  toDomain(raw: PrismaProductWizardWithRelations): ProductWizard {
    return new ProductWizard({
      ...
      order: raw.order,
      wizardQuestion: raw.wizardQuestion ? PrismaWizardQuestionMapper.toDomain(raw.wizardQuestion) : undefined,
      createdAt: raw.createdAt,
      updatedAt: raw.updatedAt
    })
  },

  toPrisma(productWizard: ProductWizard): Prisma.ProductWizardUncheckedCreateInput {
    return {
      id: productWizard.id,
